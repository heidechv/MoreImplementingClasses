...
class CapitalT(object):
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        # --------------------------------------------------------------
        h_rect_top_left_corner = rg.Point(intersection_center.x - width/2, intersection_center.y - letter_thickness/2)
        h_rect_bottom_right_corner = rg.Point(intersection_center.x + width/2, intersection_center.y + letter_thickness/2)
        self.h_rect = rg.Rectangle(h_rect_top_left_corner, h_rect_bottom_right_corner)
        v_rect_top_left_corner = rg.Point(intersection_center.x - letter_thickness/2, intersection_center.y - letter_thickness/2)
        v_rect_bottom_right_corner = rg.Point(intersection_center.x + letter_thickness/2, intersection_center.y + height - letter_thickness/2)
